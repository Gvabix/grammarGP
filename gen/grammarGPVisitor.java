...
public interface grammarGPVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link grammarGPParser#breakContinueStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBreakContinueStatement(grammarGPParser.BreakContinueStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammarGPParser#breakStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBreakStatement(grammarGPParser.BreakStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link grammarGPParser#continueStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitContinueStatement(grammarGPParser.ContinueStatementContext ctx);
	/**
